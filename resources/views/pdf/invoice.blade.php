                ...
                <tr>
                    <td class="signature-cell">
                        ...
                        @php
                            ...
                            $treasurerName = $invoice?->treasurer_name ?? $treasurerUser?->name ?? config('school.treasurer_name', 'Hj. Titi Nurhayati, S. Pd');

                            $sigBase64 = $invoice?->getSignatureBase64() ?? $treasurerUser?->getSignatureBase64();
                            if (!$sigBase64) {
