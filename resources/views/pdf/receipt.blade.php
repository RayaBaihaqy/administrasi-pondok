            ...
            <div class="info-box">
                ...
                <table class="info-table">
                    <tr>
                        ...
                        <td>:</td>
                        <td class="info-value"><strong>{{ $payment->parentProfile?->full_name ?? $payment->student?->parentProfile?->full_name ?? 'Wali Siswa' }}</strong></td>
                    </tr>
                    <tr>
            ...
            <table class="signature-table">
                <tr>
                    <td class="signature-cell">
                        <div style="color: #666; font-size: 10px;">Cibitung, {{ \Carbon\Carbon::parse($payment->paid_at ?? now())->translatedFormat('d F Y') }}</div>
